...
<form id="<?php echo $prefix; ?>_discount_contractor_form" name="<?php echo $prefix; ?>_discount_contractor_form" class="inputForm">
	...
	<table class='form'>
		<tr>
			<td>Main Trade</td>
			<td>
				<select id="input_discount_for_main_trade" onchange="_contractor_discounts.populateSubTrade(this.value, 'input_discount_for_sub_trade')">
			...
			<tr>
				<td colspan="2">
					<p class="button-panel">
						<button type="button" id="<?php echo $prefix; ?>_contractor_submit" onclick="_contractor_discounts.<?php echo $prefix; ?>Validate()"><?php echo $this->lang->line_arr('contractor->buttons_links->'.$prefix."_discount"); ?></button>
