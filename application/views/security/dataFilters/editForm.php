...
<form id="update_dataFilter_form" name="update_dataFilter_form">
	...
	<div class='form'>
		<p>
			...
			<div>
				<input type="text" name="dataFilterId" id="dataFilterId" value="<?php echo $dataFilters[$i]->data_filter_id; ?>" required>
			</div>
		</p>
		<p>
			<div class="label">Data Filter Name</div>
			<input type="text" name="dataFilterName" id="dataFilterName" value="<?php echo $dataFilters[$i]->data_filter_name; ?>" required>
		</p>
		<p>
