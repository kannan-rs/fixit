...
<div class="header-options">
	<h2 class=''><?php echo $this->lang->line_arr('data_filter->headers->view_all'); ?></h2>
</div>
<div>
	...
	<?php
		if(count($dataFilters) > 0) {
			...
			echo "<td class='cell table-action'>".$this->lang->line_arr('data_filter->summary_table->action')."</td>";
			echo "</tr>";
		}
