...
<div>
	...
	<?php
		...
		for($i = 0; $i < count($dataFilters); $i++) { 
			$deleteFn = "securityObj._dataFilters.deleteRecord(".$dataFilters[$i]->sno.")";
			echo "<tr class='row'>";
			...
			echo "<span><a href=\"javascript:void(0);\" onclick=\"securityObj._dataFilters.editDataFilter('".$dataFilters[$i]->sno."')\">".$this->lang->line_arr('data_filter->buttons_links->edit')."</a></span>";
