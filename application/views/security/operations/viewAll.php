...
<div class="header-options">
	<h2 class=''><?php echo $this->lang->line_arr('operation->headers->view_all'); ?></h2>
</div>
<div>
	...
	<?php
		if(count($operations) > 0) {
			...
			echo "<td class='cell table-action'>".$this->lang->line_arr('operation->summary_table->action')."</td>";
			echo "</tr>";
		}
