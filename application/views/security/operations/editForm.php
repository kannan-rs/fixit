...
<form id="update_operation_form" name="update_operation_form">
	...
	<div class='form'>
		<p>
			...
			<div>
				<input type="text" name="operationId" id="operationId" value="<?php echo $operations[$i]->ope_id; ?>" required>
			</div>
		</p>
		<p>
			<div class="label">Operation Name</div>
			<input type="text" name="operationName" id="operationName" value="<?php echo $operations[$i]->ope_name; ?>" required>
		</p>
		<p>
