...
<div>
	...
	<?php
		...
		for($i = 0; $i < count($users); $i++) { 
			...
			echo "<tr class='row'>";
			echo "<td class='cell'><a href=\"/main/security/users/viewone/".$users[$i]->sno."\">". $users[$i]->user_name ."</td>";
			...
			echo "<span><a href=\"/main/security/users/edit/".$users[$i]->sno."\" >".$this->lang->line_arr('user->buttons_links->edit')."</a></span>";
			if( $logged_in_email != $users[$i]->user_name) {
