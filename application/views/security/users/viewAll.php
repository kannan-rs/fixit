...
<div>
	...
	<?php
		...
		for($i = 0; $i < count($users); $i++) { 
			$deleteText = ($users[$i]->account_type =='admin') ?"": $this->lang->line_arr('user->buttons_links->delete');
			...
			echo "<span><a href=\"javascript:void(0);\" onclick=\"securityObj._users.editUser('".$users[$i]->sno."')\">".$this->lang->line_arr('user->buttons_links->edit')."</a></span>";
