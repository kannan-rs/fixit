...
<div>
	...
	<?php
		...
		for($i = 0; $i < count($roles); $i++) { 
			$deleteFn = "securityObj._roles.deleteRecord(".$roles[$i]->sno.")";
			echo "<tr class='row'>";
			...
			echo "<span><a href=\"javascript:void(0);\" onclick=\"securityObj._roles.editRole('".$roles[$i]->sno."')\">".$this->lang->line_arr('role->buttons_links->edit')."</a></span>";
