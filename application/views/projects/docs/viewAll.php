...
<div class="docs_list">
	...
	for($i=0; $i < count($project_docs); $i++) {
		$deleteFn = "_projects.documentDelete('".$project_docs[$i]->doc_id."')";
	?>
		<tr id="<?php echo 'docId_'.$project_docs[$i]->doc_id; ?>">
			<td class='cell' colspan="3">
				<!--<a href="javascript:void(0);" onclick="_docs.getAttachment('<?php echo $project_docs[$i]->doc_id; ?>')">-->
			...
			<td class="table-action">
				...
				<!--<a onclick="_docs.delete('<?php echo $project_docs[$i]->doc_id; ?>')">Delete</a></td>-->
			<?php
			}
			?>
		</tr>
