...
<div>
	...
	<table cellspacing="0" class="viewOneProject">
	<?php
		if(count($projects) > 0) {
			$i = 0;
	?>
		<tr>
			...
			<td class='cell' colspan="3"><?php echo $projects[$i]->project_name; ?></td>
		</tr>
		<tr>
			<td class='cell label'>Description:</td>
			<td class='cell' colspan="3"><?php echo $projects[$i]->project_descr; ?></td>
		</tr>
		<tr>
