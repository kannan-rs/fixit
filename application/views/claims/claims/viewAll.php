<div class="header-options">
	<h2 class=''><?php echo $this->lang->line_arr('claim->headers->view_all'); ?></h2>
<div>
	...
	?>
		<tr class='heading'>
			...
			<td class='cell'><?php echo $this->lang->line_arr('claim->summary_table->claim_descr'); ?></td>
	...
	<?php
		...
		?>
			<tr class='row viewAll'>
				...
				<td class="cell description"><?php echo $claim->claim_description; ?></td>
				...
				<td class="cell"><?php echo $claim->customer_contact_no.", ".$claim->customer_email_id; ?></td>
			</tr>
		<?php
		}
	}  else {
